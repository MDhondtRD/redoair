...
public class FlightRepositoryTest extends DataPersistenceTest {
    ...
    public void flightsShouldHaveANonNullDepartureCity(){
        Flight f = new Flight("AA0000", null, "New York", LocalDateTime.of(LocalDate.of(1985,11,12), LocalTime.now()), 15, 399.95);
        repo.createFlight(f); repo.getEntityManager().flush();
    }

    @Test(expected = PersistenceException.class)
    public void flightsShouldHaveANonNullDestinationCity(){
        Flight f = new Flight("AA0000", "London", null, LocalDateTime.of(LocalDate.of(1985,11,12),LocalTime.now()), 15, 399.95);
        repo.createFlight(f); repo.getEntityManager().flush();
    }
    ...
    public void flightsCanBeRetrievedByCode(){
        ...
        repo.createFlight(new Flight("MD1991", "London", "New York", LocalDateTime.of(LocalDate.of(1985,11,12),LocalTime.now()), 15, 15.15));
    ...
    public void flightsCanBeRetrievedByDestinationCity(){
        Flight f1 = new Flight("AA0000", "London", "New York", LocalDateTime.of(LocalDate.of(1985,11,12),LocalTime.now()), 15, 399.999);
        Flight f2 = new Flight("AA0001", "New York", "London", LocalDateTime.of(LocalDate.of(1985,11,12),LocalTime.now()), 15, 399.999);
    ...
    public void findAllFutureFlights(){
        Flight f1 = new Flight("AA0001", "London", "New York", LocalDate.of(2015, 10, 01).atTime(14,30), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "London", "New York", LocalDate.of(2015, 10, 02).atTime(14,30), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "London", "New York", LocalDate.of(2015, 10, 03).atTime(14,30), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "London", "New York", LocalDate.of(2015, 12, 01).atTime(14,30), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "London", "New York", LocalDate.of(2015, 12, 02).atTime(14,30), 15, 399.999); // 02-12-2015 14:30:00
    ...
    public void findAllFutureDestinationCities(){
        Flight f1 = new Flight("AA0001", "London", "New York", LocalDate.of(2015, 10, 01).atTime(14,30), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "London", "Detroit", LocalDate.of(2015, 10, 02).atTime(14,30), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "London", "Chicago", LocalDate.of(2015, 10, 03).atTime(14,30), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "London", "Boston", LocalDate.of(2015, 12, 01).atTime(14,30), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "London", "Philadelphia", LocalDate.of(2015, 12, 02).atTime(14,30), 15, 399.999); // 02-12-2015 14:30:00
        repo.createFlight(f1); repo.createFlight(f2); repo.createFlight(f3); repo.createFlight(f4); repo.createFlight(f5);
        repo.getEntityManager().flush();
        assertEquals(6, repo.getAllFlights().size());
        assertEquals(2, repo.getAllFutureFlights().size());
    ...
    public void findAllFutureDepartureCities(){
        Flight f1 = new Flight("AA0001", "New York", "London", LocalDate.of(2015, 10, 01).atTime(14,30), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "Detroit", "London", LocalDate.of(2015, 10, 02).atTime(14,30), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "Chicago", "London", LocalDate.of(2015, 10, 03).atTime(14,30), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "Boston", "London", LocalDate.of(2015, 12, 01).atTime(14,30), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "Philadelphia", "London", LocalDate.of(2015, 12, 02).atTime(14,30), 15, 399.999); // 02-12-2015 14:30:00
        repo.createFlight(f1); repo.createFlight(f2); repo.createFlight(f3); repo.createFlight(f4); repo.createFlight(f5);
        repo.getEntityManager().flush();
        assertEquals(6, repo.getAllFlights().size());
        assertEquals(2, repo.getAllFutureFlights().size());
    ...
    public void flightsCanBePersisted(){
        Flight f = new Flight("MD1991", "London", "New York", LocalDateTime.of(LocalDate.of(1985,11,12),LocalTime.now()), 15, 15.15);
        repo.createFlight(f); repo.getEntityManager().flush();
