...
public class FlightPersistenceTest extends DataPersistenceTest {
    ...
    public void flightsCanBeRetrievedByCode(){
        ...
        repo.createFlight(new Flight("MD1991", "London", "New York", new Date(), 15, 15.15));
    ...
    public void flightsCanBeRetrievedByDestinationCity(){
        Flight f1 = new Flight("AA0000", "London", "New York", new Date(), 15, 399.999);
        Flight f2 = new Flight("AA0001", "New York", "London", new Date(), 15, 399.999);
    ...
    public void findAllFutureFlights(){
        Flight f1 = new Flight("AA0001", "London", "New York", new Date(1443709800000L), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "London", "New York", new Date(1443796200000L), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "London", "New York", new Date(1443882600000L), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "London", "New York", new Date(1448980200000L), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "London", "New York", new Date(1449066600000L), 15, 399.999); // 02-12-2015 14:30:00
    ...
    public void findAllFutureDestinationCities(){
        Flight f1 = new Flight("AA0001", "London", "New York", new Date(1443709800000L), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "London", "Detroit", new Date(1443796200000L), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "London", "Chicago", new Date(1443882600000L), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "London", "Boston", new Date(1448980200000L), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "London", "Philadelphia", new Date(1449066600000L), 15, 399.999); // 02-12-2015 14:30:00
        repo.createFlight(f1); repo.createFlight(f2); repo.createFlight(f3); repo.createFlight(f4); repo.createFlight(f5);
        repo.getEntityManager().flush();
        assertEquals(6, repo.getAllFlights().size());
        assertEquals(2, repo.getAllFutureFlights().size());
    ...
    public void findAllFutureDepartureCities(){
        Flight f1 = new Flight("AA0001", "New York", "London", new Date(1443709800000L), 15, 399.999); // 01-10-2015 14:30:00
        Flight f2 = new Flight("AA0002", "Detroit", "London", new Date(1443796200000L), 15, 399.999); // 02-10-2015 14:30:00
        Flight f3 = new Flight("AA0003", "Chicago", "London", new Date(1443882600000L), 15, 399.999); // 03-10-2015 14:30:00
        Flight f4 = new Flight("AA0004", "Boston", "London", new Date(1448980200000L), 15, 399.999); // 01-12-2015 14:30:00
        Flight f5 = new Flight("AA0005", "Philadelphia", "London", new Date(1449066600000L), 15, 399.999); // 02-12-2015 14:30:00
        repo.createFlight(f1); repo.createFlight(f2); repo.createFlight(f3); repo.createFlight(f4); repo.createFlight(f5);
        repo.getEntityManager().flush();
        assertEquals(6, repo.getAllFlights().size());
        assertEquals(2, repo.getAllFutureFlights().size());
    ...
    public void flightsCanBePersisted(){
        Flight f = new Flight("MD1991", "London", "New York", new Date(), 15, 15.15);
        repo.createFlight(f); repo.getEntityManager().flush();
